var mainUI ={
		slide : ()=>{return '<div class="header-btn-wrap">'
			...
			+'        <div class="flip_box">'
			+'            <dl>'
			+'                <dt class="flip_btn1"><a id="btn1" class="icon on" title="박스오피스 보기">박스오피스</a></dt>'
			+'                <dd id="tab1">'
			...
			+'                         <a class="slide_prev" id="slide_prev" title="이전 목록 보기">이전 목록</a>'
			+'                         <a class="slide_next" id="slide_next" title="이전 목록 보기">다음 목록</a>'
			+'                     </div>'
			+'                     <div class="slide_box" style="height:700px;">'
